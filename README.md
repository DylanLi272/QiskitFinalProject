...
<p align="center"><img src="https://render.githubusercontent.com/render/math?math=Hamiltonian\minus Sum(Electron Kinetic Energy)\minus Sum(Nuclear Kinetic Energy)\minus Sum(Electron to Nuclear Coulombic Forces)\plus Sum(Electron to Electron Coulombic Forces)\plus Sum(Nuclear to Nuclear Coulombic Forces)"></p>
